...
@section('content')
    ...
    <div class="container-fluid">
        <h2 class="mt-4"><b>Edit {{ ucfirst($user->firstName) }}</b> - ({{ $role_id->name == 'admin' ? 'Admin' : 'User' }})
        </h2>
        <ol class="breadcrumb">
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="tel" class="form-control border-dark col-4" name="contact"
                                                    id="contact" value="{{ $user->contact }}" maxlength="10"
                                            ...
                                            <div class="col-6 mt-4">
                                                <label for="role_id" class="form-label"><b>Role's :</b></label>
                                                <div class="check">
                                                    <input class="form-check-input border-dark " type="radio"
                                                        name="role_id" value="0" id="role_id"
                                                        @if ($role_id->name == 'admin') {{ 'checked' }} @endif
                                                        required="" /> Admin
                                                    <input class="form-check-input border-dark " type="radio"
                                                        name="role_id" value="1" id="role_id"
                                                        @if ($role_id->name == 'user') {{ 'checked' }} @endif
                                                        required="" /> User
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2 row">
                                            <div class="col-6">
                                                <button name="update" id="update" type="submit"
                                                    value="update profile" class="btn btn-dark form-group px-3 mt-3">
                                                    Updation Profile
                                                </button>
                                            </div>
                                        </div>
